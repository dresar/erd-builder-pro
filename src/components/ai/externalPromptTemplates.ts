...
5. REST API CRUD & WORKFLOW CONTRACT: Detail standard production REST API endpoints for every domain module with CRUD operations (GET list, GET /:id, POST create, PUT update, DELETE soft-delete), JSON envelope structure ({ success, data, meta }), error codes, and workflow simulation transitions.
